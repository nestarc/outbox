...
export const OUTBOX_TENANT_PROVIDER = Symbol('OUTBOX_TENANT_PROVIDER');
...
export const DEFAULT_MAX_RETRY_DELAY = 86_400_000; // 24 hours in ms
export const MAX_SAFE_RETRY_DELAY = 2_147_483_647; // setTimeout-compatible upper bound
export const DEFAULT_STUCK_THRESHOLD = 300_000; // 5 minutes in ms
export const DEFAULT_HEARTBEAT_FAILURE_TOLERANCE = 1;
